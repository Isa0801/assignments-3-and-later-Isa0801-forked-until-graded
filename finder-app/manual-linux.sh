...
path_dir_gcc=$(aarch64-none-linux-gnu-gcc -print-sysroot)

# TODO: Add library dependencies to rootfs
cp ${path_dir_gcc}/lib64/libm.so.6 ${OUTDIR}/rootfs/lib64
cp ${path_dir_gcc}/lib64/libresolv.so.2 ${OUTDIR}/rootfs/lib64
cp ${path_dir_gcc}/lib64/libc.so.6 ${OUTDIR}/rootfs/lib64
cp ${path_dir_gcc}/lib/ld-linux-aarch64.so.1 ${OUTDIR}/rootfs/lib
